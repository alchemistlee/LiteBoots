...
_ENET_TRAIN_DATASETS = [
    [
        ...
        ("training/europarl-v8.et-en.et", "training/europarl-v8.et-en.en")
    ],
    [
    ...
    [
        ...
        ("rapid2016.en-et.et", "rapid2016.en-et.en")
    ],
]
...
_ENET_TEST_DATASETS = [[
    ...
    ("newsdev2018-enet-ref.et", "newsdev2018-enet-src.en")
]]


@registry.register_problem
class TranslateEtenWmt32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateEtenWmtCharacters(translate.TranslateProblem):
  """Problem spec for WMT18 En-Et translation."""
