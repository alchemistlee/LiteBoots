...
_ENCS_TRAIN_DATASETS = [
    [("https://lindat.mff.cuni.cz/repository/xmlui/bitstream/handle/"
     ...
     ("tsv", 2, 3, "data.plaintext-format/*train.gz")],
    [
    ...
    [
        ...
        ("commoncrawl.cs-en.cs", "commoncrawl.cs-en.en")
    ],
    [
        "http://www.statmt.org/wmt13/training-parallel-europarl-v7.tgz",
        ("training/europarl-v7.cs-en.cs", "training/europarl-v7.cs-en.en")
    ],
]
_ENCS_TEST_DATASETS = [
    [
        "http://data.statmt.org/wmt17/translation-task/dev.tgz",
        ("dev/newstest2013.cs", "dev/newstest2013.en")
    ],
]


@registry.register_problem
class TranslateCsenWmt32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateCsenWmtCharacters(translate.TranslateProblem):
