...
_ENHI_TRAIN_DATASETS = [
    [
        "https://s3.amazonaws.com/web-language-models/paracrawl/release1/enhi.tgz", #hubo data
        ("enhi/enhi.en",
         "enhi/enhi.hi")
    ],
]
...
class TranslateEnhiWmt32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateEnhiWmtCharacters(translate.TranslateProblem):
  """Problem spec for WMT18 En-Et translation."""
