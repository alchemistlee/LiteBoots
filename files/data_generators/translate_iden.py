...
_ENID_TRAIN_DATASETS = [
    [
        ...
        ("IWSLT17.train.en-id.tok.id", "IWSLT17.train.en-id.tok.en")
    ],
    [
        _REPO + "PANL-BPPT-ECO-EN-ID-150Kw.tok.tgz",
        ("PANL-BPPT-ECO-ID-150Kw.tok.txt", "PANL-BPPT-ECO-EN-150Kw.tok.txt")
    ],
    [
        _REPO + "PANL-BPPT-INT-EN-ID-150Kw.tok.tgz",
        ("PANL-BPPT-INT-ID-150Kw.tok.txt", "PANL-BPPT-INT-EN-150Kw.tok.txt")
    ],
    [
        _REPO + "PANL-BPPT-SCI-EN-ID-100Kw.tok.tgz",
        ("PANL-BPPT-SCI-ID-100Kw.tok.txt", "PANL-BPPT-SCI-EN-100Kw.tok.txt")
    ],
    [
        _REPO + "PANL-BPPT-SPO-EN-ID-100Kw.tok.tgz",
        ("PANL-BPPT-SPO-ID-100Kw.tok.txt", "PANL-BPPT-SPO-EN-100Kw.tok.txt")
    ],
    [
        "https://s3.amazonaws.com/web-language-models/paracrawl/release1/enid.tgz", #hubo data
        ("enid/enid.id",
         "enid/enid.en")
    ],
]
...
class TranslateIdenIwslt32k(translate.TranslateProblem):
