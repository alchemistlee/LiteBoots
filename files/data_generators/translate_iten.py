...
_ENIT_TRAIN_DATASETS = [
    [
        "https://s3.amazonaws.com/web-language-models/paracrawl/release1/enit.tgz", #hubo data
        ("enit/enit.it",
         "enit/enit.en")
    ],
]
...
class TranslateItenWmt32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateItenWmtCharacters(translate.TranslateProblem):
  """Problem spec for WMT18 En-Ar translation."""
