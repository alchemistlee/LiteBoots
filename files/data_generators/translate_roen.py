...
_ENRO_TRAIN_DATASETS = [
    [
        ...
        ("europarl-v7.ro-en.ro", "europarl-v7.ro-en.en")
    ],
    [
        "http://opus.nlpl.eu/download.php?f=SETIMES/v2/moses/en-ro.txt.zip",
        ("SETIMES.en-ro.ro", "SETIMES.en-ro.en")
    ]
]
_ENRO_TEST_DATASETS = [
    [
...
@registry.register_problem
class TranslateRoenWmtCharacters(TranslateRoenWmt8k):
  """Problem spec for WMT En-Ro translation."""
...
@registry.register_problem
class TranslateRoenWmtMulti64k(TranslateRoenWmt8k):
...
@registry.register_problem
class TranslateRoenWmtMultiSmall64k(TranslateRoenWmt8k):
  ...
  def generate_samples(self, data_dir, tmp_dir, dataset_split):
    ...
    if dataset_split != problem.DatasetSplit.TRAIN:
      for x in super(TranslateRoenWmtMultiSmall64k, self).generate_samples(
...
@registry.register_problem
class TranslateRoenWmtMultiTiny64k(TranslateRoenWmtMultiSmall64k):
...
@registry.register_problem
class TranslateRoenWmtMultiTiny64kPacked1k(TranslateRoenWmtMultiTiny64k):
  """Translation with muli-lingual vocabulary."""
