...
_ENRU_TRAIN_DATASETS = [
    [
        "https://s3.amazonaws.com/web-language-models/paracrawl/release1/enru.tgz", #hubo data
        ("enru/enru.ru",
         "enru/enru.en")
    ],
]
...
class TranslateRuenWmt32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateRuenWmtCharacters(translate.TranslateProblem):
  """Problem spec for WMT18 En-Et translation."""
