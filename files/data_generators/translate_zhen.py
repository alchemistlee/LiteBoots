...
# tigerobo datasets
_CIBA_TRAIN_DATASETS = [[
    "https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/ciba.tgz",
    ["ciba/ciba.zh", "ciba/ciba.en"]
]]

_FT_TRAIN_DATASETS = [[
    "https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/ft_chinese.tgz",
    ["ft_chinese/ft.zh", "ft_chinese/ft.en"]
]]

_NYT_TRAIN_DATASETS = [[
    "https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/newyork_times.tgz",
    ["newyork_times/nt.zh", "newyork_times/nt.en"]
]]
...
_UN_TRAIN_DATASETS = [[
    ...
    ["en-zh/UNv1.0.en-zh.zh", "en-zh/UNv1.0.en-zh.en"]]]
...
_CWMT_TRAIN_DATASETS = [
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/casia2015/casia2015_ch.txt", "cwmt/casia2015/casia2015_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/casict2015/casict2015_ch.txt",
      "cwmt/casict2015/casict2015_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/neu2017/NEU_cn.txt", "cwmt/neu2017/NEU_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2015/datum_ch.txt", "cwmt/datum2015/datum_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book1_cn.txt", "cwmt/datum2017/Book1_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book2_cn.txt", "cwmt/datum2017/Book2_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book3_cn.txt", "cwmt/datum2017/Book3_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book4_cn.txt", "cwmt/datum2017/Book4_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book5_cn.txt", "cwmt/datum2017/Book5_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book6_cn.txt", "cwmt/datum2017/Book6_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book7_cn.txt", "cwmt/datum2017/Book7_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book8_cn.txt", "cwmt/datum2017/Book8_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book9_cn.txt", "cwmt/datum2017/Book9_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book10_cn.txt", "cwmt/datum2017/Book10_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book11_cn.txt", "cwmt/datum2017/Book11_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book12_cn.txt", "cwmt/datum2017/Book12_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book13_cn.txt", "cwmt/datum2017/Book13_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book14_cn.txt", "cwmt/datum2017/Book14_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book15_cn.txt", "cwmt/datum2017/Book15_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book16_cn.txt", "cwmt/datum2017/Book16_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book17_cn.txt", "cwmt/datum2017/Book17_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book18_cn.txt", "cwmt/datum2017/Book18_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book19_cn.txt", "cwmt/datum2017/Book19_en.txt"]],
    ["https://s3-us-west-2.amazonaws.com/twairball.wmt17.zh-en/cwmt.tgz",
     ["cwmt/datum2017/Book20_cn.txt", "cwmt/datum2017/Book20_en.txt"]]
]
...
class TranslateZhenWmt32k(translate.TranslateProblem):
  ...
  def source_vocab_name(self):
    return "vocab.zhen-zh.%d" % self.approx_vocab_size

  @property
  def target_vocab_name(self):
    return "vocab.zhen-en.%d" % self.approx_vocab_size
  ...
  def get_training_dataset(self, tmp_dir):
    ...
    for dataset in [_CIBA_TRAIN_DATASETS, _FT_TRAIN_DATASETS, _NYT_TRAIN_DATASETS, _CWMT_TRAIN_DATASETS, _UN_TRAIN_DATASETS]:
      filename = get_filename(dataset)
      tmp_filepath = os.path.join(tmp_dir, filename)
      if tf.gfile.Exists(tmp_filepath):
        full_dataset += dataset
      else:
        tf.logging.info("[TranslateZhenWmt] dataset incomplete, you need to "
                        "manually download %s" % filename)
    return full_dataset

  def generate_encoded_samples(self, data_dir, tmp_dir, dataset_split):
    print("Generating Encoded samples")
...
@registry.register_problem
class TranslateZhenWmt8k(TranslateZhenWmt32k):
