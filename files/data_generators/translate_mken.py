...
_ENMK_TRAIN_DATASETS = [[
    ...
    ("setimes.en-mk.mk.txt", "setimes.en-mk.en.txt")
]]
...
class TranslateMkenSetimes32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslateEMkenSetimesCharacters(translate.TranslateProblem):
  """Problem spec for SETimes En-Mk translation."""
