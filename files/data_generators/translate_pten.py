...
class TranslatePtenWmt32k(translate.TranslateProblem):
...
@registry.register_problem
class TranslatePtenWmtClean32k(TranslatePtenWmt32k):
  """En-pt translation trained on WMT with further cleaning."""

  @property
  def use_vocab_from_other_problem(self):
    return TranslatePtenWmt32k()
...
@registry.register_problem
class TranslatePtenWmt32kPacked(TranslatePtenWmt32k):
...
@registry.register_problem
class TranslatePtenWmt8k(TranslatePtenWmt32k):
...
@registry.register_problem
class TranslatePtenWmt8kPacked(TranslatePtenWmt8k):
  ...
  @property
  def use_vocab_from_other_problem(self):
    return TranslatePtenWmt8k()


@registry.register_problem
class TranslatePtenWmtCharacters(TranslatePtenWmt8k):
  """Problem spec for WMT En-Es translation."""
